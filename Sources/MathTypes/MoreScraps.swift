...
//public protocol BuiltinScalarType {
//    static func promote(_ value: BuiltinScalarType) -> Self;
//}
//
//extension Int : BuiltinScalarType {
//    public static func promote(_ value: BuiltinScalarType) -> Int {
//        return 0
//    }
//    public static func promote(_ value: Int) -> Int {
//        return value
//    }
//}
//
//extension Float : BuiltinScalarType {
//    public static func promote(_ value: BuiltinScalarType) -> Float {
//        return nan
//    }
//    public static func promote(_ value: Float) -> Float {
//        return value
//    }
//}
//
//extension Double : BuiltinScalarType {
//    public static func promote(_ value: BuiltinScalarType) -> Double {
...
//        return nan
//    }
//    public static func promote(_ value: Int) -> Double {
//        return Double(value)
//    }
//    public static func promote(_ value: Float) -> Double {
//        return Double(value)
//    }
//    public static func promote(_ value: Double) -> Double {
//        return value
//    }
//}
...
public protocol RealNumber {
    ...
    init(_ real: RawType)
    //    func promote<U>(_ value: U) -> RawType
}

extension RealNumber {
    func promote<RawType>(_ value: RawType) -> RawType {
        return value
    }
}
...
// Multiple conformances is banned: https://github.com/apple/swift-evolution/blob/master/proposals/0143-conditional-conformances.md
...
extension Real : RealNumberPromotable where T == Double {
    ...
    public static func promote(_ real: Float) -> Double {
        return Double(real)
    }
    
    public static func promote(_ real: Int) -> Double {
        return Double(real)
    }
}

//public protocol PromotableRawType {
//    associatedtype PromotableType
//    static func promote (_ val: PromotableType) -> Self
//}
//
//extension Float : PromotableRawType {
//    public typealias PromotableType = Int
//    public static func promote(_ value: Int) -> Float {
//        return Float(value)
//    }
//}
...
public extension RealNumberPromotable {
    static func +<S>(lhs: S, rhs: Self) -> Self where S:RealNumber, S.RawType == PromotableRawType {
        return Self.init( promote(lhs.raw) + rhs.raw )
    }
